...
//**I attempted to move the API call into this factory instead of having it in the controller**
  ...
  //   return $resource("http://api.crossref.org/works/" + dois[0], {}, {'get':    {method:'GET'}})
  // }

  // urlVm = this;
  //  urlVm.queryCrossref= function() {
  //   $http({
  //     method: "GET",
...
//   IndexControllerFunction.$inject = ["UrlFactory"];
//   function IndexControllerFunction(UrlFactory){
//     var indexVm = this;
//     for(i = 0; i < dois.length; i++){
//       UrlFactory.query();
//
//     // indexVm.newDoi = new UrlFactory();
//     }
// }
